...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # Try to match as much as possible (from the beginning of the match)
  ...
  #
  # Former is used to check for characters and latter is used to check for words, generally.
